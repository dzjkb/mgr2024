# adapted from https://github.com/acids-ircam/RAVE/
# type: ignore

"""
Implements a Pseudo-Quadrature Mirror Filter bank to split a signal into N bands as suggested in Multi-Band MelGAN
see [A Kaiser Window Approach for the Design of Prototype Filters of Cosine Modulated Filterbanks](https://files.core.ac.uk/download/pdf/216113507.pdf)
"""
...
class PQMF(nn.Module):
    ...
    def __init__(self, attenuation, n_band, n_channels = 1):
        super().__init__()
